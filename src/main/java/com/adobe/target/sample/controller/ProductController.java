...
public class ProductController {
     ...
     * variable which is finally applied by at.js in the browser. You should see "Women's Luxury Fake Bag"
     * if offer is applied succesfully. If not, you should see "Women's Luxury Leather Bag"
     */
    @GetMapping
     ...
     * eventually applied by at.js. You should see "Gucci" appended to the product title if the product
     * is "Women's Luxury Leather Bag". Nothing otherwise.
     */
    @GetMapping("{id}")
